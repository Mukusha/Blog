# **Блог**
### _Web-приложение создавалось для курса "Промышленная разработка на Java (осень 2022)" Naumen_
 После прохождения курса, продолжаю совершенствовать проект
...
_Добавления после защиты проекта на курсе:_
